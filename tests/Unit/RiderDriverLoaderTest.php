...
it('loads the package demo driver', function () {
    ...
    expect($driver['name'])->toBe('demo')
        ->and(data_get($driver, 'rider.stages'))->toHaveCount(6)
        ...
        ->and(data_get($driver, 'rider.stages.4.key'))->toBe('demo-success-message')
        ->and(data_get($driver, 'rider.stages.5.key'))->toBe('demo-redirect')
    ;
});